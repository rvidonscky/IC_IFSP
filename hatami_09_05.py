...
Original file is located at
    https://colab.research.google.com/drive/1ceT9bmEBZIZVM9aho04s9u8wIMCD5DLT
"""
...
eq_17 = Eq(TemperaturaVidro.forward,
           (TemperaturaVidro[t, x, z+1] + coef_topo * TemperaturaAr) / (1 + coef_topo),
           subdomain=topo)
...
rec_term = rec_T.interpolate(expr=TemperaturaPlaca)
